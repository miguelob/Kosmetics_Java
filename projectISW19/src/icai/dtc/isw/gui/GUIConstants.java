...
public class GUIConstants {
	  ...
	  /**Fuente para títulos de la interfaz gráfica, en este caso "SERIF_MD", en negrita y de tamano 20
	  */
	  public static final Font FONT_TITLE = new Font("Font.SERIF_MD", Font.BOLD, 20);
	  /**Fuente para títulos principales de la interfaz gráfica, en este caso "SERIF_MD", en negrita y de tamano 20
	  */
